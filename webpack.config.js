...
const styleConfig = require("./src/qwc2-demo-app/styleConfig");
...
module.exports = (env, argv) => {
    ...
    return {
        entry: {
            QWC2App: path.resolve(__dirname, 'src', 'index.jsx')
        },
        output: {
            hashFunction: 'sha256',
        ...
        devServer: {
            static: [
                {
                    directory: path.resolve(__dirname, 'src/qwc2-demo-app/static'),
                    publicPath: '/'
                }
            ],
            compress: true,
        ...
        plugins: [
            ...
            new webpack.NormalModuleReplacementPlugin(/openlayers$/, path.join(__dirname, "src/qwc2-demo-app/qwc2", "libs", "openlayers")),
